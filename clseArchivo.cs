...
namespace pryLopezIEvaluativa
{
    ...
    internal class clseArchivo
    {
        ...
        public void Grabar(string datosConcatenados)
            ...
            //AD.Close();: Finalmente, esta línea cierra el objeto StreamWriter AD. Es importante cerrar el objeto después de usarlo para liberar los recursos asociados y garantizar que todos los datos pendientes se escriban en el archivo.
...
//En resumen, este código representa una clase que se utiliza para escribir líneas de texto en un archivo CSV. El método Grabar acepta una cadena de texto como entrada y la agrega al final del archivo CSV especificado en la ruta "../../Resources/Lista.csv".
